#!/bin/sh -
# ==========================================================
# This script is to run geant topology scenario
...
# the network. 
# The demand type is morning, afternoon, evening, based on time
# dc_type: 'n' (no datacenter)
# bin: determin whether the variable is binary or not, selecting
# proper ampl model file 
# seed: the initial seed for generating random cost
# 
# Code by Xuan Liu
# Dec. 22, 2013
# ==========================================================
