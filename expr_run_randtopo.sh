...
do
	...
	for load_type in nonuniform #uniformeij uniforme1n #uniform uniforme1n uniformeij nonuniform nonuniformh nonuniforme1n nonuniformeij
	do
		# first find feasible capacity
		capacity=100
		for obj_type in mcr #lb ad mcr
		do
