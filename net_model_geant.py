...
import model_create_geant as mc
...
def create_option(parser):
    ...
    parser.add_option("-t", dest="topo_type",
                      type="str",
                      default="random",
                      help="Topology type: grid/ring/full/geant/")
    parser.add_option("-d", dest="demand_type",
                      type="str",
                      default="morning",
                      help="Demand Type: morning/afternoon/evening")
    ...
    parser.add_option("--dc", dest="dc_type",
                      ...
                      geant topology: adjacent('a')/far('f')
                      No data centers: 'n'
                      """)
